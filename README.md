# nomad_forematicstest

Testing nomad plugin
...
```sh
git clone https://github.com/mcasademont9/nomad_forematicstest.git
cd nomad_forematicstest
...
```sh
pip install dist/nomad_forematicstest-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Miquel Casademont | [mcasademont@icmab.es](mailto:mcasademont@icmab.es)
